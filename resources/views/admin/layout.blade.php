...
<head>
    ...
    <meta name="description" content="Lashop">

    <title>Lashop - E-Commerce App</title>
...
<body class="header-fixed sidebar-fixed sidebar-dark header-light" id="body">
    ...
    <div class="wrapper">
        <!-- Github Link -->
        <a href="https://github.com/dibaliqaja/lashop" target="_blank" class="github-link">
